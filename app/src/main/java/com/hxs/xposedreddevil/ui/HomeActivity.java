...
public class HomeActivity extends BaseActivity {
    ...
    private void DataInit() {
        ...
        if (PropertiesUtils.getValue(RED_FILE, "wechatversion", "").equals("7.0.15")) {
        ...
        if (spCenterVersion.getSelectedItem().equals("7.0.15")) {
            PropertiesUtils.putValue(RED_FILE, "wechatversion", "7.0.15");
        } else if (spCenterVersion.getSelectedItem().equals("7.0.14")) {
