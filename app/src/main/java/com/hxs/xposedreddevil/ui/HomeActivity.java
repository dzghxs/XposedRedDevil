...
//        synthesizer.release();
    ...
    private void DataInit() {
        ...
        if (PropertiesUtils.getValue(RED_FILE, "wechatversion", "").equals("7.0.19")) {
        ...
        if (spCenterVersion.getSelectedItem().equals("7.0.19")) {
            PropertiesUtils.putValue(RED_FILE, "wechatversion", "7.0.19");
